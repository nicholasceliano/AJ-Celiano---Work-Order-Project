...
(function (PageData) {
    ...
    function LoadAdminPanel() {
        viewModel = {
            jobs: new ReferenceDataModeling.ReferenceDataActions(JSONCalls.GetJobs()),
            devices: new ReferenceDataModeling.ReferenceDataActions(JSONCalls.GetAllDevicesNames()),
            users: new ReferenceDataModeling.ReferenceDataActions(JSONCalls.GetAllUserNames())
        };
        ko.applyBindings(viewModel);
    }
    ...
    function GetvmInstance() {
        ...
        if (page == 1)
            ...
            else if (viewModelSubInstance == 'users') {
